class BudgetController:
    ...
    def __init__(self, transaction_service, budget_service, report_service) -> None:
    ...
    def get_summary(self, user_id: int, month: int, year: int) -> dict:
        return self.budget_service.get_summary(user_id, month, year)

    def get_balance(self, user_id: int, month: int, year: int) -> float:
        return self.budget_service.calculate_balance(user_id, month, year)

    def get_monthly_report(self, user_id: int, month: int, year: int):
        return self.report_service.get_monthly_report(user_id, month, year)

    def get_monthly_summary(self, user_id: int, month: int, year: int) -> dict:
        return self.report_service.get_monthly_summary(user_id, month, year)

    def get_top_expense_category(self, user_id: int, month: int, year: int):
        return self.report_service.get_top_expense_category(user_id, month, year)
